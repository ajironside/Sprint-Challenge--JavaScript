...
const tRex = {
        ...
        roar: function() { return console.log('RAWERSRARARWERSARARARRRR!') }
    }
...
console.log(raptor.food);

// How long was a stegosaurus?
console.log(stego.length);

// What time period did tyrannosaurus live in?
console.log(tRex.time);
...
// I couldn't get the a,b sort to work, so I decided to go with a for loop
...
zooAnimals.forEach((items) => {
    return displayNames.push(`Name: ${items.animal_name}, Scientific Name: ${items.scientific_name}`);
});
